...
/*! \class Monstru3 extends Enemy
    \brief Implementeaza al 3 lea tip de inamic posibil
 */
public class Monstru3 extends Enemy
{
    Animation monstru3_stg;  /*!<Animatie directie stanga a inamicului .*/
    Animation monstru3_drt; /*!<Animatie directie dreapta a inamicului.*/
    /*! \fn     public Monstru3(RefLinks refLink,float x, float y)
    ...
    public Monstru3(RefLinks refLink,float x, float y)
    {
        super(refLink, x,y, Character.DEFAULT_CREATURE_WIDTH, Character.DEFAULT_CREATURE_HEIGHT);
        monstru3_stg=new Animation(200, Assets.monstru3_stg);
        monstru3_drt=new Animation(200, Assets.monstru3_dr);


        normalBounds.x =5 ;//collisson box pt Rick e la 16 pixeli spre dreapta fata de imaginea in ansamblu
        normalBounds.y = 5;
 ...
 */
    ...
    */
    ...
    {
        if(xMove<0)
            return monstru3_stg.getImgCurenta();
            //else if(xMove>0)
            //return monstru1_drt.getImgCurenta();
        else return monstru3_drt.getImgCurenta();
